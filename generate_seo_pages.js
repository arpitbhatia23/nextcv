...
const pages = [
  {
    ...
    sections: [
      ...
      "Single Column ATS Resume Templates",
      "Company Resume Formats",
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    description:
      "Build an ATS-friendly TCS resume format for freshers. Use ready-made resume templates for TCS NQT, BCA, B.Tech, IT and fresher job applications.",
    h1: "TCS Resume Format for Freshers (2026)",
    sections: [
      "Best TCS Resume Format for Freshers",
      "TCS NQT Resume Format",
      "What to Include in a TCS Fresher Resume",
      "TCS Resume Format for BCA and B.Tech Students",
      "Skills to Add in TCS Resume",
      "Project Examples for TCS Resume",
      "TCS Resume Mistakes to Avoid",
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    description:
      "Create an ATS-friendly Infosys resume format for freshers. Use ready-made resume templates for BCA, B.Tech, IT and non-IT freshers applying to Infosys jobs.",
    ...
    sections: [
      ...
      "Skills to Add in Infosys Resume",
      "Project Examples for Infosys Resume",
      "Common Mistakes in Infosys Resume",
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    description:
      "Create an ATS-friendly Wipro resume format for freshers. Use clean resume templates for IT, BCA, B.Tech and non-IT fresher roles.",
    h1: "Wipro Resume Format for Freshers (2026)",
    sections: [
      "Best Wipro Resume Format for Freshers",
      "Key Sections for Wipro Resume",
      "Wipro Resume Format for B.Tech and IT Freshers",
      "Essential Skills for Wipro Jobs",
  ...
  },
  {
    ...
    sections: [
      "Best Cognizant Resume Format",
      "What to Include in CTS Resume",
      "Cognizant Resume for IT Professionals",
      "Key Skills for Cognizant",
      "CTS ATS Screening",
    ],
    faqs: [
      {
        q: "What is CTS resume?",
        a: "CTS stands for Cognizant Technology Solutions, so a CTS resume is tailored for their job openings.",
      },
      {
        q: "Does Cognizant use ATS?",
        a: "Yes, like most MNCs, Cognizant uses Applicant Tracking Systems to screen resumes.",
      },
      {
        q: "How to stand out for Cognizant roles?",
        a: "Highlight specific technical projects and certifications relevant to the role you are applying for.",
      },
      {
        q: "Which template is best for Cognizant?",
        a: "A clean, ATS-friendly single-column template is highly recommended.",
      },
    ],
  },
  {
    ...
    sections: [
      "Best Tech Mahindra Resume Format",
      "Important Sections to Include",
      "Tech Mahindra Skills",
      "Projects for Tech Mahindra Resume",
      "Resume Tips",
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    sections: [
      "Best LTIMindtree Resume Format",
      "What to Include",
      "LTIMindtree Resume for IT Freshers",
      "Key Skills",
      "LTIMindtree ATS Guide",
    ],
    faqs: [
      {
        q: "How to make an ATS friendly resume for LTIMindtree?",
        a: "Use standard headings, avoid complex formatting, and include keywords from the job description.",
      },
      {
        q: "What roles does LTIMindtree hire freshers for?",
        a: "They hire for various roles including software engineers, analysts, and support staff.",
      },
      {
        q: "Can I use NextCV for LTIMindtree?",
        a: "Yes, NextCV provides ATS-friendly templates suitable for LTIMindtree.",
      },
      {
        q: "How many pages should the resume be?",
        a: "One page is standard and recommended for freshers.",
      },
    ],
  },
  {
    ...
    description:
      "Check your resume ATS score online for free. Find missing skills, formatting issues and ATS problems before applying to TCS, Infosys, Wipro, Accenture and more.",
  ...
  },
  {
    ...
    sections: [
      ...
      "Best ATS Format for Indian Freshers",
      "How to Write ATS Friendly Skills",
  ...
  },
  {
    ...
    sections: [
      "Best Fresher Resume Format",
      "Resume for B.Tech Freshers",
      "Resume for BCA and MCA Freshers",
      "Resume for Commerce and MBA",
      "Key Skills for Freshers",
    ],
    faqs: [
      {
        q: "What is the standard fresher resume format in India?",
        a: "A reverse-chronological format focusing on education, skills, and academic projects is standard.",
      },
      {
        q: "Should freshers include an objective statement?",
        a: "Yes, a concise objective statement tailored to the job can be beneficial.",
      },
      {
        q: "How to list projects on a fresher resume?",
        a: "Include the project title, technologies used, your role, and the outcome.",
      },
      {
        q: "Is a 2-page resume okay for freshers?",
        a: "Usually, 1 page is preferred unless you have extensive projects or internships.",
      },
    ],
  },
  {
    ...
    sections: [
      "What MNCs Look for in a Resume",
      "Best MNC Resume Format",
      "MNC Resume for IT Freshers",
      "Essential Skills for MNC Jobs",
      "How to Pass MNC ATS Screening",
    ],
    faqs: [
      {
        q: "What is an MNC resume?",
        a: "It is a resume tailored to meet the standards and expectations of Multinational Corporations.",
      },
      {
        q: "Do all MNCs use ATS?",
        a: "Yes, almost all major MNCs use Applicant Tracking Systems to handle large volumes of applications.",
      },
      {
        q: "How to format a resume for MNCs?",
        a: "Keep it clean, professional, and use a standard, easily readable font.",
      },
      {
        q: "Should I customize my resume for each MNC?",
        a: "Yes, tailoring your skills and objective to the specific job description is highly recommended.",
      },
    ],
  },
  {
    ...
    sections: [
      "Cost of Making a Resume in India",
      "Free vs Paid Resume Builders",
      "Why Choose NextCV?",
      "ATS Resume Download Pricing",
      "Value of a Professional Resume",
    ],
    faqs: [
      {
        q: "Is NextCV free?",
  ...
  },
  {
    ...
    sections: [
      ...
      "Which One Should Freshers Use in India?",
      "Examples and Templates",
    ],
    faqs: [
      {
        q: "Is CV and resume the same in India?",
        a: "While often used interchangeably, a resume is typically shorter (1-2 pages) and a CV is longer and more detailed.",
      },
      {
        q: "Should freshers use a CV or a resume?",
        a: "Freshers in India should generally use a resume for corporate jobs and internships.",
      },
      {
        q: "When is a CV used?",
        a: "A CV is mostly used for academic, research, or highly specialized positions.",
      },
      {
        q: "Can I call my resume a CV?",
        a: "In the Indian corporate context, yes, HR often uses the terms interchangeably.",
      },
    ],
  },
];
...
const dynamicSeoSlugs = new Set(
  JSON.parse(fs.readFileSync(path.join(baseDir, "seo-pages.json"), "utf8")).map(page => page.slug)
);

pages
  .filter(page => !dynamicSeoSlugs.has(page.path))
  .forEach(page => {
