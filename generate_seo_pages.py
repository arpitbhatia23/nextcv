...
for page in pages:
    ...
    include_templates = page["path"] in ["templates", "tcs-resume-format-for-freshers", "infosys-resume-format-for-freshers", "wipro-resume-format-for-freshers", "cognizant-resume-format-for-freshers", "tech-mahindra-resume-format-for-freshers", "ltimindtree-resume-format-for-freshers", "fresher-resume-format-india", "mnc-resume-format-for-freshers"]
    templates_jsx = """
...
export default function Page() {{
  const faqs = {json.dumps(page['faqs'])};
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12 bg-white">
      ...
      <h1 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900">{page['h1']}</h1>
