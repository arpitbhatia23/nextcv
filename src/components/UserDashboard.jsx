...
const UserDashboard = () => {
  ...
  return (
    <div className="min-h-screen p-6 md:p-10 font-[--font-geist-sans] bg-slate-50">
      <div className="max-w-7xl mx-auto mb-10" id="tour-dashboard-header">
            ...
            <div className="grid gap-8">
              ...
              >
                <Card className="h-full border-2 border-slate-200 bg-white hover:border-indigo-500 hover:shadow-xl hover:shadow-indigo-500/10 transition-all duration-300 rounded-2xl overflow-hidden relative">
                  <div className="absolute top-0 right-0 w-44 h-44 bg-indigo-50 rounded-bl-full -mr-12 -mt-12 transition-transform group-hover:scale-110" />
                  <CardContent className="p-6 md:p-8 relative flex flex-col md:flex-row items-center gap-6">
                    <div className="w-full md:w-78 h-56 md:h-96 relative rounded-lg overflow-hidden bg-slate-100 mx-auto">
                      <Image
                        src="/amazon.webp"
                        alt="Resume template"
                        width={500}
                    ...
                    <div className="w-full md:w-1/2">
                      <div className="w-12 h-12 rounded-2xl bg-indigo-100 flex items-center justify-center mb-4 text-indigo-600 group-hover:scale-110 transition-transform duration-300">
                      ...
                      <p className="text-slate-500 mb-6 leading-relaxed">
                        Step into your next role with confidence. Our AI-guided
                        builder helps you craft a high-impact resume that gets
                        noticed by top recruiters.
                      </p>
                      <div className="flex items-center gap-4">
                        <Link
                          href="/dashboard/resumeform"
                          className="inline-flex items-center bg-indigo-600 text-white px-4 py-2 rounded-md font-semibold"
                        >
                          Start Form Builder{" "}
