    ...
    <div className="py-2">
      <div className="flex flex-col lg:grid lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <Card className="border-none shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white rounded-xl md:rounded-3xl overflow-hidden">
            <div className="bg-indigo-600/5 px-6 py-4 border-b border-indigo-100/50 flex items-center justify-between">
              <span className="text-xs md:text-sm font-black text-indigo-600 uppercase tracking-widest flex items-center gap-2">
              ...
              {isEditing && (
                <Button
                  ...
                  size="sm"
                  onClick={cancelEdit}
                  className="h-8 text-xs font-bold text-slate-400 hover:text-slate-600"
                >
                  Cancel
                </Button>
              )}
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <div className="flex justify-between items-center mb-1">
                          <FormLabel className="text-slate-900 font-semibold md:font-bold">
                            Key Coursework / Awards
                          </FormLabel>
                          <button
                            type="button"
        ...
        <div className="lg:col-span-6 space-y-8">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs font-semibold md:font-bold text-indigo-600 bg-indigo-50 px-3 py-1 rounded-full">
            ...
            <AnimatePresence initial={false}>
              {educationList.length === 0 ? (
                <motion.div
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  className="bg-white border-2 border-dashed border-slate-100 rounded-4xl p-12 text-center"
                >
                ...
                educationList.map(edu => (
                  ...
                  >
                    {/* Timeline Node */}
                    <div className="absolute -left-6.75 top-8 w-4 h-4 rounded-full border-4 border-white shadow-md bg-indigo-600 z-10" />

                    <Card className="group border-none bg-white hover:bg-indigo-50/50 shadow-[0_4px_20px_rgb(0,0,0,0.02)] hover:shadow-[0_20px_40px_rgb(79,70,229,0.08)] rounded-2xl md:rounded-4xl transition-all overflow-hidden">
                      <CardContent className="p-2 md:p-6">
                        <div className="flex items-start justify-between gap-4">
                          <div className="space-y-1">
                            ...
                            <div className="flex items-center gap-2 text-indigo-600 font-semibold md:font-bold text-sm">
                          ...
                          <div className="flex flex-col gap-2">
                            <button
                              ...
                              className="p-2 bg-slate-50 text-slate-400 hover:text-indigo-600 hover:bg-white rounded-md md:rounded-xl shadow-sm transition-all"
                            >
                              <Edit2 className="w-4 h-4" />
                            </button>
                            <button
                              onClick={() => handleDelete(edu.id)}
                              className="p-2 bg-slate-50 text-slate-400 hover:text-red-500 hover:bg-white rounded-md md:rounded-xl shadow-sm transition-all"
                            >
