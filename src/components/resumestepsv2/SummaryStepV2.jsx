            ...
            <div className="p-2">
                          ...
                          <AnimatePresence>
                            {isGenerating && (
                              <motion.div
                                ...
                                animate={{ opacity: 1 }}
                                exit={{ opacity: 0 }}
                                className="absolute inset-0 bg-white/60 backdrop-blur-md rounded-4xl flex flex-col items-center justify-center gap-4 z-10"
                              >
              ...
              <div className="mt-8 flex items-center justify-between text-slate-400">
                <div className="flex gap-1.5 items-center">
                  <CheckCircle2
                    className={`w-4 h-4 transition-colors ${watchedSummary.length >= 50 ? "text-emerald-500" : "text-slate-200"}`}
                  />
