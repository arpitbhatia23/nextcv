...
function AnimatedCounter({ to, className }) {
  ...
  return <motion.div className={`text-3xl font-bold ${className}`}>{display}</motion.div>;
}
...
export default function TestimonialCarousel() {
  ...
  return (
    <section name="Testimonial" className="bg-white py-12 overflow-hidden w-full dark:bg-black">
      {/* Header */}
      <div className="text-center">
        <h2 className="text-4xl font-bold text-gray-800 dark:text-white">0</h2>
        <p className="text-lg text-gray-600 mt-2 dark:text-gray-300">
          Join thousands of satisfied users who landed their dream jobs with Next CV.
        </p>
      </div>
