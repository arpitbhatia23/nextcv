        ...
        <>
            <section className="px-4 py-12">
                ...
                <Card className="max-w-6xl mx-auto p-6 sm:p-10 space-y-8 border-none shadow-none">
                    <h1 className="text-3xl sm:text-4xl font-bold text-center">Why Our Process Works</h1>

                    {/* Features */}
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
                        {works.map(({ icon, title, description }, index) => (
                            <CardContent key={index} className="text-center space-y-2 max-w-xs">
                ...
                <div className="text-center mt-10 space-y-4">
                    <Button className="bg-blue-700 px-8 py-4 text-lg sm:text-xl font-semibold hover:bg-blue-800">
                        Start Your Resume Now
                    </Button>
                    <p className="text-gray-700">Join thousands of successful job seekers</p>
                </div>
            </section>
