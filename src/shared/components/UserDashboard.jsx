        ...
        <header className="mb-12 relative">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
            <div className="space-y-3">
              ...
              <p className="text-slate-500 text-lg md:text-sm max-w-2xl leading-relaxed font-light">
                Craft high-impact, HR-approved resumes in minutes. Fast, simple, and effective.
              </p>
            </div>
            <div>
              <Link href="/dashboard/my-resume">
                <button className="px-4 py-2 rounded-xl font-semibold text-slate-700 bg-white border border-slate-200 hover:bg-slate-50 hover:border-slate-300 transition-all shadow-sm">
                  My Resumes
                </button>
              </Link>
            </div>
              ...
              <Card className="overflow-hidden border-0 bg-white shadow-[0_20px_50px_rgba(0,0,0,0.05)] rounded-3xl  border-slate-100 hover:shadow-[0_30px_60px_rgba(0,0,0,0.08)] transition-all duration-300">
                <CardContent className="p-0 flex flex-col md:flex-row">
                  <div className="flex-1 p-8 flex flex-col justify-center">
                    <div className="w-10 h-10 rounded-lg bg-indigo-600 flex items-center justify-center mb-4 text-white shadow-lg shadow-indigo-200">
                    ...
                    <div className="flex items-center gap-6">
                      <div className="px-8 py-4 bg-indigo-600 text-white rounded-lg font-bold text-sm flex items-center gap-2 hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-100">
                        Launch Builder
                        <Rocket className="w-5 h-5" />
                      </div>
                      <div className="flex flex-col">
                        <span className="text-indigo-600 font-bold text-sm leading-tight">₹49</span>
                  ...
                  <div className="w-full hidden md:w-[40%] bg-slate-50 relative min-h-52 md:flex items-center justify-center p-4">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {steps.map((step, idx) => (
                  <div
                    key={idx}
                    className={`bg-white p-6 rounded-lg border ${step.borderColor} shadow-sm hover:shadow-md transition-all flex flex-col h-full group`}
                  >
                    <div
                      className={`w-10 h-10 rounded-lg ${step.color} flex items-center justify-center mb-4`}
                    >
                      {step.icon}
                    </div>
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <Link href="/dashboard/full-ai-resume" className="block group">
              <Card className="border-0 bg-linear-to-br from-purple-600 to-indigo-700 text-white rounded-3xl overflow-hidden shadow-xl shadow-purple-100 transition-all duration-300 hover:shadow-purple-200 hover:-translate-y-0.5">
                <CardContent className="p-8 relative">
                  ...
                  <h3 className="text-lg font-bold mb-2">AI Chat Resume</h3>
            ...
            <Card className="border-0 bg-slate-900 text-white rounded-3xl overflow-hidden shadow-xl">
              <CardContent className="p-8">
                <div className="p-3 w-fit bg-indigo-500 rounded-lg mb-6">
                  <IndianRupee className="w-6 h-6 text-white" />
                </div>
                <h3 className="text-sm font-bold mb-2">Simple Pricing</h3>
                ...
                <button className="w-full py-4 bg-white text-slate-900 rounded-lg font-bold hover:bg-slate-100 transition-colors shadow-lg">
                  Get Started
                </button>
              </CardContent>
            </Card>
