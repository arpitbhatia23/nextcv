    ...
    <>
      ...
      <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-indigo-100">
        ...
        <section className="relative pt-32 pb-20 px-6 overflow-hidden">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-200 h-125 bg-indigo-50/50 rounded-full blur-3xl -z-10" />
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed mb-10">
              ...
              . We help freshers and students create ATS-friendly resumes
              ...
              <div className="flex-1 space-y-6">
                ...
                <div className="space-y-4 text-slate-600 leading-relaxed">
                  <p>
                    ...
                    <span className="font-semibold text-slate-800">
                      resume builders are too expensive
                    </span>
                    . Most platforms charge ₹500-1200/month, which is hard for
                    students to justify.
                  </p>
                  <p>
                    We believed there had to be a better way. A way to get a
                    high-quality,{" "}
                    <span className="font-semibold text-slate-800">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-slate-600 max-w-2xl mx-auto">
                To democratize career opportunities by making professional
                resume tools accessible to every student in India.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="bg-slate-800/50 p-8 rounded-2xl border border-slate-700 backdrop-blur">
                ...
                <p className="text-slate-400 text-sm leading-relaxed">
                  Full-stack developer passionate about building tools that
                  solve real problems.
                </p>
              </div>
              ...
              <div className="bg-slate-800/50 p-8 rounded-2xl border border-slate-700 backdrop-blur">
                ...
                <p className="text-slate-400 text-sm leading-relaxed">
                  Obsessed with user experience and making technology accessible
                  to everyone.
                </p>
              </div>
            </div>
