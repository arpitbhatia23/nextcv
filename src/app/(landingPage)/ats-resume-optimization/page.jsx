...
export const metadata = createSeoMetadata({
  ...
  description:
    "Optimize your resume for ATS systems with better keywords, clean formatting, correct sections and job-specific resume improvements.",
              ...
              <div className="mt-6 space-y-4">
                <div className="rounded-xl border border-slate-100 bg-slate-50 p-4 sm:p-5">
                  <h3 className="flex items-start gap-2 text-base font-bold leading-snug text-slate-900 sm:text-lg">
                    ...
                    <span>{"Hard Skills vs. Soft Skills Keywords"}</span>
                  </h3>

                  <p className="mt-2 pl-7 text-sm leading-7 text-slate-600">
                    {
                      "Apply hard skills vs. soft skills keywords carefully to improve clarity, ATS readability and the overall presentation of your resume."
                    }
                  </p>
                </div>
                ...
                <div className="rounded-xl border border-slate-100 bg-slate-50 p-4 sm:p-5">
                  ...
                  <p className="mt-2 pl-7 text-sm leading-7 text-slate-600">
                    {
                      "Apply action verbs carefully to improve clarity, ATS readability and the overall presentation of your resume."
                    }
                  </p>
                </div>
              </div>
              ...
              <div className="mt-6 space-y-4">
                <div className="rounded-xl border border-slate-100 bg-slate-50 p-4 sm:p-5">
                  <h3 className="flex items-start gap-2 text-base font-bold leading-snug text-slate-900 sm:text-lg">
                    ...
                    <span>{"Step 1: Analyze the Job Description"}</span>
                  </h3>

                  <p className="mt-2 pl-7 text-sm leading-7 text-slate-600">
                    {
                      "Apply step 1: analyze the job description carefully to improve clarity, ATS readability and the overall presentation of your resume."
                    }
                  </p>
                </div>
                ...
                <div className="rounded-xl border border-slate-100 bg-slate-50 p-4 sm:p-5">
                  <h3 className="flex items-start gap-2 text-base font-bold leading-snug text-slate-900 sm:text-lg">
                    ...
                    <span>{"Step 2: Use Exact Phrase Matching"}</span>
                  </h3>

                  <p className="mt-2 pl-7 text-sm leading-7 text-slate-600">
                    {
                      "Apply step 2: use exact phrase matching carefully to improve clarity, ATS readability and the overall presentation of your resume."
                    }
                  </p>
                </div>
                ...
                <div className="rounded-xl border border-slate-100 bg-slate-50 p-4 sm:p-5">
                  <h3 className="flex items-start gap-2 text-base font-bold leading-snug text-slate-900 sm:text-lg">
                    ...
                    <span>{"Step 3: Contextualize Your Skills"}</span>
                  </h3>

                  <p className="mt-2 pl-7 text-sm leading-7 text-slate-600">
                    {
                      "Apply step 3: contextualize your skills carefully to improve clarity, ATS readability and the overall presentation of your resume."
                    }
                  </p>
                </div>
              </div>
              ...
              <div className="relative z-10 space-y-3">
                <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
                  <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
                    ...
                    <span>{"What is ATS resume optimization?"}</span>
                  </h3>
                ...
                <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
                  <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
                    ...
                    <span>{"How do I find the right ATS keywords?"}</span>
                  </h3>
                ...
                <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
                  <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
                    ...
                    <span>{"Does keyword frequency matter for ATS?"}</span>
                  </h3>
                ...
                <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
                  <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
                    ...
                    <span>{"What is 'keyword stuffing' on a resume?"}</span>
                  </h3>
                ...
                <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
                  <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
                    ...
                    <span>{"Should I use exact phrasing from the job description?"}</span>
                  </h3>
                ...
                <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
                  <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
                    ...
                    <span>{"How can I check my ATS optimization score?"}</span>
                  </h3>
                ...
                <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
                  <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
                    ...
                    <span>{"Does optimizing for ATS ruin the resume for humans?"}</span>
                  </h3>
                ...
                <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
                  <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
                    ...
                    <span>{"Are soft skills important for ATS optimization?"}</span>
                  </h3>
                ...
                <ul className="space-y-2">
                  ...
                  <li>
                    <Link
                      ...
                      className="group flex items-center justify-between gap-3 rounded-xl border border-slate-700 bg-slate-800/70 p-3 text-sm font-medium text-slate-200 transition-colors hover:border-indigo-500 hover:bg-indigo-600 hover:text-white"
                    >
                      <span className="min-w-0 capitalize">{"Ats Friendly Resume Tips"}</span>
