...
export const metadata = createSeoMetadata({
  ...
  description:
    "Create an ATS-friendly Tech Mahindra resume format for freshers applying to IT, support, analyst and trainee roles.",
  path: "/tech-mahindra-resume-format",
  keywords: [
    "tech mahindra resume format",
    "tech mahindra resume for freshers",
              ...
              <div className="mt-6 space-y-4">
                <div className="rounded-xl border border-slate-100 bg-slate-50 p-4 sm:p-5">
                  <h3 className="flex items-start gap-2 text-base font-bold leading-snug text-slate-900 sm:text-lg">
                    ...
                    <span>{"Highlighting Telecom and IT Skills"}</span>
                  </h3>

                  <p className="mt-2 pl-7 text-sm leading-7 text-slate-600">
                    {
                      "Apply highlighting telecom and it skills carefully to improve clarity, ATS readability and the overall presentation of your resume."
                    }
                  </p>
                </div>
                ...
                <div className="rounded-xl border border-slate-100 bg-slate-50 p-4 sm:p-5">
                  <h3 className="flex items-start gap-2 text-base font-bold leading-snug text-slate-900 sm:text-lg">
                    ...
                    <span>{"Showcasing Practical Experience"}</span>
                  </h3>

                  <p className="mt-2 pl-7 text-sm leading-7 text-slate-600">
                    {
                      "Apply showcasing practical experience carefully to improve clarity, ATS readability and the overall presentation of your resume."
                    }
                  </p>
                </div>
              </div>
              ...
              <div className="relative z-10 space-y-3">
                <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
                  <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
                    ...
                    <span>{"What is the standard Tech Mahindra resume format?"}</span>
                  </h3>
                ...
                <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
                  <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
                    ...
                    <span>{"What technical skills does Tech Mahindra look for?"}</span>
                  </h3>
                ...
                <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
                  <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
                    ...
                    <span>{"Is an objective statement necessary for Tech Mahindra?"}</span>
                  </h3>
                ...
                <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
                  <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
                    ...
                    <span>{"Does Tech Mahindra use an ATS?"}</span>
                  </h3>
                ...
                <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
                  <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
                    ...
                    <span>{"How do I make my resume stand out for Tech Mahindra?"}</span>
                  </h3>
                ...
                <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
                  <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
                    ...
                    <span>{"Should I include my full postal address?"}</span>
                  </h3>
                ...
                <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
                  <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
                    ...
                    <span>{"Can I use a two-column resume for Tech Mahindra?"}</span>
                  </h3>
                ...
                <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
                  <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
                    ...
                    <span>{"Where can I build a Tech Mahindra format resume?"}</span>
                  </h3>
              ...
              <div className="overflow-hidden rounded-2xl border border-slate-800 bg-slate-900 p-5 text-white shadow-sm sm:p-6">
                ...
                <ul className="space-y-2">
                  <li>
                    ...
                    >
                      <span className="min-w-0 capitalize">{"Hcl Resume Format For Freshers"}</span>
