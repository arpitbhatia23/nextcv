  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12 bg-white">
      ...
      <h1 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900">
        CV vs Resume in India: What is the Difference?
      </h1>
      <p className="text-lg text-gray-700 mb-8">
        Understand the difference between CV and resume in India. Learn which one freshers should
        use for jobs, internships and campus placements.
      </p>
