...
export default function SEOPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the best resume format for non-IT freshers?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "A hybrid format works best, emphasizing core business skills (like Excel or Tally), college leadership roles, internships, and communication skills."
      }
    },
    {
      "@type": "Question",
      "name": "What skills should a BCom fresher include?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Include skills like Advanced Excel, Financial Accounting, Tally ERP, Data Analysis, and strong verbal/written communication."
      }
    },
    {
      "@type": "Question",
      "name": "How do I make my non-IT resume stand out?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Highlight specific achievements from college fests, leadership positions in student societies, or practical outcomes from business internships."
      }
    },
    {
      "@type": "Question",
      "name": "Do I need to worry about ATS for non-IT jobs?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, large banks, financial institutions, and FMCG companies all use Applicant Tracking Systems. ATS compliance is critical."
      }
    },
    {
      "@type": "Question",
      "name": "Should a BBA fresher include a career objective?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, a clear objective showing your passion for marketing, finance, or HR helps align your resume with the specific role."
      }
    },
    {
      "@type": "Question",
      "name": "Can I include volunteer work?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Absolutely. Volunteer work demonstrates initiative, teamwork, and soft skills which are highly valued in the non-IT corporate sector."
      }
    },
    {
      "@type": "Question",
      "name": "What software tools should non-IT freshers know?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Proficiency in MS Office (especially Excel), Google Workspace, basic CRM tools, and Canva/Photoshop (for marketing) are huge pluses."
      }
    },
    {
      "@type": "Question",
      "name": "Where can I find non-IT resume templates?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "NextCV provides versatile, ATS-friendly templates that are perfect for finance, marketing, HR, and sales freshers."
      }
    }
  ]
};
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-slate-900 mb-6 leading-[1.1] tracking-tight">
                Building a Powerful Non-IT Resume for Freshers
              </h1>
              <p className="text-lg sm:text-xl text-slate-600 mb-10 leading-relaxed max-w-2xl">
                Download the perfect non-IT resume for freshers. Tailor your BCom, BBA, or BA resume to highlight communication, analytics, and business acumen.
              </p>
        ...
        <main className="max-w-7xl mx-auto px-6 lg:px-8 py-16 grid lg:grid-cols-12 gap-12">
          ...
          <section className="bg-white p-8 sm:p-10 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 mt-10 hover:-translate-y-1 transition-transform duration-300 relative overflow-hidden group">
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold mb-5 text-slate-900 flex items-center gap-3 relative z-10">
              ...
              How Non-IT Resumes Differ from IT Resumes
            </h2>
            <p className="text-slate-600 mb-6 text-lg leading-relaxed relative z-10">
              Explore the core principles of <strong>How Non-IT Resumes Differ from IT Resumes</strong>. Understanding these concepts is critical for freshers aiming to build a high-converting, ATS-friendly resume.
            </p>
          ...
          <section className="bg-white p-8 sm:p-10 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 mt-10 hover:-translate-y-1 transition-transform duration-300 relative overflow-hidden group">
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold mb-5 text-slate-900 flex items-center gap-3 relative z-10">
              ...
              Top Skills to Highlight for Non-IT Roles
            </h2>
            <p className="text-slate-600 mb-6 text-lg leading-relaxed relative z-10">
              Explore the core principles of <strong>Top Skills to Highlight for Non-IT Roles</strong>. Understanding these concepts is critical for freshers aiming to build a high-converting, ATS-friendly resume.
            </p>
            <div className="pl-4 sm:pl-12 border-l border-slate-100 relative z-10 space-y-6">
              ...
              <div className="relative">
                ...
                <p className="text-slate-600 leading-relaxed">
                  Implementing communication and presentation strategically improves formatting and boosts ATS parsability for this section.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <p className="text-slate-600 leading-relaxed">
                  Implementing analytical and quantitative skills strategically improves formatting and boosts ATS parsability for this section.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <h3 className="text-xl font-bold mb-2 text-indigo-950 flex items-center gap-2">
                  <CheckCircle2 className="w-5 h-5 text-indigo-500" />
                  Software Proficiency (Excel, Tally, CRM)
                </h3>
                <p className="text-slate-600 leading-relaxed">
                  Implementing software proficiency (excel, tally, crm) strategically improves formatting and boosts ATS parsability for this section.
                </p>
              </div>
      </div></section>
          ...
          <section className="bg-white p-8 sm:p-10 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 mt-10 hover:-translate-y-1 transition-transform duration-300 relative overflow-hidden group">
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold mb-5 text-slate-900 flex items-center gap-3 relative z-10">
              ...
              The Best Resume Format for BCom & BBA Freshers
            </h2>
            <p className="text-slate-600 mb-6 text-lg leading-relaxed relative z-10">
              Explore the core principles of <strong>The Best Resume Format for BCom & BBA Freshers</strong>. Understanding these concepts is critical for freshers aiming to build a high-converting, ATS-friendly resume.
            </p>
            <div className="pl-4 sm:pl-12 border-l border-slate-100 relative z-10 space-y-6">
      </div></section>
          ...
          <section className="bg-white p-8 sm:p-10 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 mt-10 hover:-translate-y-1 transition-transform duration-300 relative overflow-hidden group">
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold mb-5 text-slate-900 flex items-center gap-3 relative z-10">
              ...
              Leveraging College Societies and Extracurriculars
            </h2>
            <p className="text-slate-600 mb-6 text-lg leading-relaxed relative z-10">
              Explore the core principles of <strong>Leveraging College Societies and Extracurriculars</strong>. Understanding these concepts is critical for freshers aiming to build a high-converting, ATS-friendly resume.
            </p>
            <div className="pl-4 sm:pl-12 border-l border-slate-100 relative z-10 space-y-6">
      </div></section>
            ...
            <section className="bg-white p-8 sm:p-10 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 mt-16 relative overflow-hidden">
              ...
              <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100 hover:border-indigo-200 transition-colors">
                <h3 className="font-bold text-slate-900 text-lg flex items-start gap-3">
                  ...
                  What is the best resume format for non-IT freshers?
                </h3>
                <p className="text-slate-600 mt-3 ml-8 leading-relaxed">
                  A hybrid format works best, emphasizing core business skills (like Excel or Tally), college leadership roles, internships, and communication skills.
                </p>
              </div>
              ...
              <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100 hover:border-indigo-200 transition-colors">
                <h3 className="font-bold text-slate-900 text-lg flex items-start gap-3">
                  <span className="text-indigo-500 font-black text-2xl leading-none">Q.</span>
                  What skills should a BCom fresher include?
                </h3>
                <p className="text-slate-600 mt-3 ml-8 leading-relaxed">
                  Include skills like Advanced Excel, Financial Accounting, Tally ERP, Data Analysis, and strong verbal/written communication.
                </p>
              </div>
              ...
              <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100 hover:border-indigo-200 transition-colors">
                <h3 className="font-bold text-slate-900 text-lg flex items-start gap-3">
                  <span className="text-indigo-500 font-black text-2xl leading-none">Q.</span>
                  How do I make my non-IT resume stand out?
                </h3>
                <p className="text-slate-600 mt-3 ml-8 leading-relaxed">
                  Highlight specific achievements from college fests, leadership positions in student societies, or practical outcomes from business internships.
                </p>
              </div>
              ...
              <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100 hover:border-indigo-200 transition-colors">
                <h3 className="font-bold text-slate-900 text-lg flex items-start gap-3">
                  <span className="text-indigo-500 font-black text-2xl leading-none">Q.</span>
                  Do I need to worry about ATS for non-IT jobs?
                </h3>
                <p className="text-slate-600 mt-3 ml-8 leading-relaxed">
                  Yes, large banks, financial institutions, and FMCG companies all use Applicant Tracking Systems. ATS compliance is critical.
                </p>
              </div>
              ...
              <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100 hover:border-indigo-200 transition-colors">
                <h3 className="font-bold text-slate-900 text-lg flex items-start gap-3">
                  <span className="text-indigo-500 font-black text-2xl leading-none">Q.</span>
                  Should a BBA fresher include a career objective?
                </h3>
                <p className="text-slate-600 mt-3 ml-8 leading-relaxed">
                  Yes, a clear objective showing your passion for marketing, finance, or HR helps align your resume with the specific role.
                </p>
              </div>
              ...
              <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100 hover:border-indigo-200 transition-colors">
                ...
                <p className="text-slate-600 mt-3 ml-8 leading-relaxed">
                  Absolutely. Volunteer work demonstrates initiative, teamwork, and soft skills which are highly valued in the non-IT corporate sector.
                </p>
              </div>
              ...
              <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100 hover:border-indigo-200 transition-colors">
                <h3 className="font-bold text-slate-900 text-lg flex items-start gap-3">
                  <span className="text-indigo-500 font-black text-2xl leading-none">Q.</span>
                  What software tools should non-IT freshers know?
                </h3>
                <p className="text-slate-600 mt-3 ml-8 leading-relaxed">
                  Proficiency in MS Office (especially Excel), Google Workspace, basic CRM tools, and Canva/Photoshop (for marketing) are huge pluses.
                </p>
              </div>
              ...
              <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100 hover:border-indigo-200 transition-colors">
                <h3 className="font-bold text-slate-900 text-lg flex items-start gap-3">
                  <span className="text-indigo-500 font-black text-2xl leading-none">Q.</span>
                  Where can I find non-IT resume templates?
                </h3>
                <p className="text-slate-600 mt-3 ml-8 leading-relaxed">
                  NextCV provides versatile, ATS-friendly templates that are perfect for finance, marketing, HR, and sales freshers.
                </p>
              </div>
              </div>
            </section>
