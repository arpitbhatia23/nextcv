    ...
    <main className="max-w-5xl mx-auto px-6 py-24 text-gray-800 ">
      ...
      <section className="space-y-6">
        <p>
          ...
          Technology Act, 2000 and is published in accordance with Rule 3(1) of
          the IT (Intermediaries Guidelines) Rules, 2011. It governs the use of
          the Ghost Option platform.
        </p>
        ...
        <p>
          By using the platform , including the mobile site or app (hereinafter
          referred to as the "Platform"), you agree to the following terms and
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            The Platform may contain links to third-party websites, governed by
        ...
        <p>
          Initiating a transaction on the Platform constitutes a legally binding
          contract with the Platform Owner. You agree to pay all applicable
          charges.
        </p>
        ...
        <p>
          ...
          affiliates against any claims arising from your breach of these terms,
          policies, laws, or infringement of third-party rights.
        </p>
