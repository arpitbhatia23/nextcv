...
export default function PricingPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Professional resume writers in India typically charge between ₹1,000 to ₹5,000 depending on your experience level. NextCV offers agency-level quality through AI for a fraction of that cost.",
    },
    {
      question: "Can I create a resume for free?",
      answer:
        "Yes, you can create a basic resume using Word or Google Docs for free. However, if you want an ATS-friendly, professional layout with AI assistance, premium tools like NextCV offer exceptional value starting at just ₹49.",
    },
    {
      question: "What is the difference between free and paid resume builders?",
      answer:
        "Free builders often have basic templates, hidden watermarks, or lack ATS optimization. Paid resume builders offer premium designs, AI content generation, keyword optimization, and high-quality PDF downloads without watermarks.",
    },
    {
      question: "What is the cheapest resume builder?",
      answer:
        "NextCV is one of the most affordable professional resume builders in India, offering premium ATS-friendly templates starting at just ₹49 with no hidden monthly subscriptions.",
    },
    {
      question: "How much does an ATS-friendly resume cost?",
      answer:
        "While some agencies charge ₹2,000+ for an ATS-optimized resume, you can build a 100% ATS-friendly resume on NextCV starting at just ₹49 using our pre-tested templates.",
    },
    {
      question: "Should freshers pay for resume writing services?",
      answer:
        "Freshers don't need expensive ₹3,000 writing services. An affordable resume builder that provides professional templates and AI bullet points (like NextCV at ₹49) is the perfect, cost-effective solution for campus placements.",
    },
  ];
      ...
      <main className="bg-white text-slate-900 font-sans">
        ...
        <section className="pb-24 px-6 lg:px-8">
          <div className="mx-auto max-w-lg">
            <div className="rounded-xl p-1 bg-linear-to-b from-indigo-500 to-purple-600 shadow-2xl">
              <div className="bg-white rounded-[20px] p-8 md:p-10 h-full flex flex-col relative overflow-hidden">
                ...
                <div className="mb-6">
                  <h3 className="text-lg font-bold text-slate-900">Premium Resume</h3>
                ...
                <div className="flex items-baseline mb-8">
                  <span className="text-xl font-bold tracking-tight text-slate-500 mr-2 uppercase ">
                    Starting at
                  </span>
                  <span className="text-xl font-extrabold tracking-tight text-slate-900">₹49</span>
                  <span className="text-lg font-semibold text-slate-500 ml-2">/ resume</span>
                </div>
        ...
        <section className="py-20 bg-slate-50 border-y border-slate-200 px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-lg font-bold text-center text-slate-900 mb-16">
        ...
        <section className="py-20 px-6 lg:px-8 max-w-4xl mx-auto prose prose-slate">
          ...
          <div className="grid sm:grid-cols-3 gap-6 not-prose mb-8">
            <div className="p-4 bg-indigo-50 rounded-lg border border-indigo-100">
              ...
              <p className="text-lg font-bold text-indigo-600">₹500 – ₹3000</p>
            ...
            <div className="p-4 bg-purple-50 rounded-lg border border-purple-100">
              ...
              <p className="text-lg font-bold text-purple-600">₹2000 – ₹10000</p>
            ...
            <div className="p-4 bg-green-50 rounded-lg border border-green-100">
              ...
              <p className="text-lg font-bold text-green-600">₹0 – ₹999</p>
          ...
          <h2 className="text-lg font-bold text-slate-900 mt-12">
          ...
          <h2 className="text-lg font-bold text-slate-900 mt-16">
            Professional Resume Writing Cost in India
          </h2>
          <p>
            If you're comparing tools versus hiring a human writer, here is the standard
            professional resume cost breakdown in the Indian market:
          </p>
          <div className="overflow-x-auto my-8">
            <table className="min-w-full border-collapse border border-slate-200 bg-white">
              <thead className="bg-slate-50">
                <tr>
                  <th className="border border-slate-200 px-6 py-3 text-left text-sm font-semibold text-slate-900">
                    Service Type
                  </th>
                  <th className="border border-slate-200 px-6 py-3 text-left text-sm font-semibold text-slate-900">
                    Average Cost
              ...
              <tbody>
                <tr>
                  <td className="border border-slate-200 px-6 py-4 text-sm text-slate-700">
                    NextCV Premium Builder
                  </td>
                  <td className="border border-slate-200 px-6 py-4 text-sm font-bold text-indigo-600">
                    ₹49 - ₹99
                  </td>
                  <td className="border border-slate-200 px-6 py-4 text-sm text-slate-700">
                    Instant
                ...
                <tr>
                  ...
                  <td className="border border-slate-200 px-6 py-4 text-sm font-bold text-slate-900">
                    ₹1,000 - ₹3,000
                  </td>
                  <td className="border border-slate-200 px-6 py-4 text-sm text-slate-700">
                    3 - 5 Days
          ...
          <div className="mt-16 bg-slate-900 text-white p-8 rounded-2xl not-prose shadow-xl">
            <h2 className="text-lg font-bold mb-6">Resume Banane Mein Kitna Paisa Lagta Hai?</h2>
            <div className="space-y-6 text-slate-300">
              <p className="text-sm">
                Agar aap search kar rahe hain ki ek professional{" "}
                <strong>resume banane me kitna paisa lagta hai</strong>, toh yahan clear cost
                breakdown hai:
              </p>
              <div className="space-y-4">
                ...
                <div className="bg-indigo-900/50 p-4 rounded-xl border border-indigo-700 flex justify-between items-center">
                  <span className="font-medium text-indigo-100">
                    Premium Resume Builder (NextCV)
                  </span>
                  <span className="text-lg font-bold text-indigo-400">₹49 – ₹99</span>
                </div>
                <div className="bg-slate-800/50 p-4 rounded-xl border border-slate-700 flex justify-between items-center">
                  <span className="font-medium">Professional Resume Writing Service</span>
                  <span className="text-lg font-bold text-slate-400">₹500 – ₹5000+</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-24 bg-slate-50 px-6 lg:px-8 border-t border-slate-200">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-lg font-bold text-center text-slate-900 mb-16 flex items-center justify-center gap-2">
