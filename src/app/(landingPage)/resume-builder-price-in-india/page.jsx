...
export const metadata = createSeoMetadata({
  ...
  description:
    "Understand resume making charges in India. Compare free tools, pay-per-download platforms, subscriptions and professional resume writers.",
        ...
        <section className="relative overflow-hidden border-b border-slate-200 bg-white pb-14 pt-28 sm:pb-20 sm:pt-32">
          ...
          <div className="relative z-10 mx-auto max-w-4xl px-5 text-center sm:px-6 lg:px-8">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-sm leading-7 text-slate-600">
              {
                "Explore general informational questions about resume-making costs in India. For our specific pricing, please check the "
              }{" "}
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-3 text-sm leading-7 text-slate-600">
                    When you ask "resume banane me kitna paisa lagta hai?", the answer depends on
                    the method you choose. Here is a breakdown of the typical options available in
                    India, ranging from free DIY tools to premium agency services. Let's compare
                    free builders, pay-per-download tools, subscriptions, and professional writers.
                  </p>
                </div>
              </div>
            ...
            <section className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition-shadow hover:shadow-md sm:p-8">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-3 text-sm leading-7 text-slate-600">
                    If you are a fresher looking for a quick and ATS-friendly solution, a
                    pay-per-download tool like NextCV is a great investment. For highly experienced
                    candidates targeting executive roles, professional writers might provide the
                    nuance required. Check{" "}
                    <Link href="/pricing" className="text-indigo-600 hover:underline">
                      NextCV's pricing
                    </Link>{" "}
                    to see our affordable options.
                  </p>
                </div>
              </div>
            ...
            <section className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition-shadow hover:shadow-md sm:p-8">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-3 text-sm leading-7 text-slate-600">
                    In summary, resume making charges vary widely. Free tools are good for simple
                    needs, pay-per-download ranges from ₹49 to ₹300, subscriptions can cost ₹500 to
                    ₹1500 per month, and professional writers charge upwards of ₹2000.
                  </p>
                </div>
              </div>
                ...
                <ul className="space-y-2">
                  ...
                  <li>
                    <Link
                      ...
                      className="group flex items-center justify-between gap-3 rounded-xl border border-slate-700 bg-slate-800/70 p-3 text-sm font-medium text-slate-200 transition-colors hover:border-indigo-500 hover:bg-indigo-600 hover:text-white"
                    >
                      <span className="min-w-0 capitalize">{"Best Resume Builder India 2026"}</span>
