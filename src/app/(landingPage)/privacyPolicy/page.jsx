    ...
    <main className="max-w-5xl mx-auto px-6 py-24 text-gray-800">
      ...
      <section className="space-y-6">
        ...
        <p>
          ...
          services, you agree to be bound by this Privacy Policy, Terms of Use,
        ...
        <p>
          ...
          be collected. If you interact with third-party partners, their privacy
          policies will apply. We are not responsible for them.
        </p>
        <p>
        ...
        <p>
          ...
          agencies under legal obligations or to protect our users and platform.
        </p>
