  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12 bg-white">
      ...
      <h1 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900">
        MNC Resume Format for Freshers (2026)
      </h1>
      <p className="text-lg text-gray-700 mb-8">
        Create a professional MNC resume format for freshers applying to TCS, Infosys, Wipro,
        Accenture, Cognizant, Capgemini and more.
      </p>
