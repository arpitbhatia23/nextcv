  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "Fresher Resume Format India (2026)",
        item: "https://www.nextcv.in/fresher-resume-format-india",
      },
    ],
  };
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12 bg-white">
      ...
      <p className="text-lg text-gray-700 mb-8">
        Create an ATS-friendly fresher resume for Indian jobs. Best format for BCA, B.Tech, MBA,
        commerce, IT and non-IT freshers.
      </p>
      ...
      <div className="prose max-w-none text-gray-800">
        <h2 className="text-2xl font-semibold mt-8 mb-4">Best Fresher Resume Format</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">Resume for B.Tech Freshers</h2>
        <p className="mb-4">
          This section is designed to guide Indian freshers in creating an optimal resume for 2026.
          Make sure to include relevant skills, internships, and educational background correctly
          structured for Applicant Tracking Systems (ATS).
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">Resume for BCA and MCA Freshers</h2>
        <p className="mb-4">
          This section is designed to guide Indian freshers in creating an optimal resume for 2026.
          Make sure to include relevant skills, internships, and educational background correctly
          structured for Applicant Tracking Systems (ATS).
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">Resume for Commerce and MBA</h2>
        <p className="mb-4">
          This section is designed to guide Indian freshers in creating an optimal resume for 2026.
          Make sure to include relevant skills, internships, and educational background correctly
          structured for Applicant Tracking Systems (ATS).
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">Key Skills for Freshers</h2>
        <p className="mb-4">
          This section is designed to guide Indian freshers in creating an optimal resume for 2026.
          Make sure to include relevant skills, internships, and educational background correctly
          structured for Applicant Tracking Systems (ATS).
