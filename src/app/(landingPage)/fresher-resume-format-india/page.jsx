...
export default function Page() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12 bg-white">
      ...
      <h1 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900">Fresher Resume Format India (2026)</h1>
      <p className="text-lg text-gray-700 mb-8">Create an ATS-friendly fresher resume for Indian jobs. Best format for BCA, B.Tech, MBA, commerce, IT and non-IT freshers.</p>
