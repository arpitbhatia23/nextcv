...
export default function SEOPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the meaning of an ATS friendly resume?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "An ATS-friendly resume is formatted specifically to be read and understood by Applicant Tracking Systems software without losing data."
      }
    },
    {
      "@type": "Question",
      "name": "What does ATS stand for?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "ATS stands for Applicant Tracking System, which is software used by recruiters to organize and filter job applications."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "If you can copy all the text from your PDF and paste it into a plain text editor smoothly without missing words, it is likely ATS friendly."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Most mid-to-large companies and MNCs like TCS, Infosys, and Wipro use ATS to handle bulk hiring."
      }
    },
    {
      "@type": "Question",
      "name": "Does an ATS friendly resume have to be boring?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Not necessarily. It should be clean and professional, which is often preferred by recruiters over overly designed, flashy templates."
      }
    },
    {
      "@type": "Question",
      "name": "Can I put my photo on an ATS resume?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "It is not recommended. Photos can confuse ATS parsers and are generally not required for IT and corporate roles in India."
      }
    },
    {
      "@type": "Question",
      "name": "What happens if a resume is not ATS friendly?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The software may scramble the text or fail to identify your skills, resulting in automatic rejection even if you are highly qualified."
      }
    },
    {
      "@type": "Question",
      "name": "Where can I find ATS friendly templates?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "NextCV offers a wide range of free, verified ATS-friendly resume templates tailored for Indian job seekers."
      }
    }
  ]
};
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-sm sm:text-lg font-bold tracking-tight text-slate-900 mb-6 max-w-4xl mx-auto leading-[1.1]">
                What Does 'ATS Friendly Resume' Actually Mean?
              </h1>
              <p className="text-sm sm:text-base text-slate-600 mb-10 leading-relaxed max-w-2xl">
                What is the meaning of an ATS friendly resume? Learn exactly what makes a resume ATS compatible and why Indian companies require it.
              </p>
        ...
        <main className="max-w-7xl mx-auto px-6 lg:px-8 py-16 grid lg:grid-cols-12 gap-12">
          ...
          <section className="bg-white p-8 sm:p-10 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 mt-10 hover:-translate-y-1 transition-transform duration-300 relative overflow-hidden group">
            ...
            <h2 className="text-lg sm:text-xl  mb-5 text-slate-900 flex items-center gap-3 relative z-10">
              ...
              Decoding the ATS: A Quick Overview
            </h2>
            <p className="text-slate-600 mb-6 text-sm leading-relaxed relative z-10">
              Explore the core principles of <strong>Decoding the ATS: A Quick Overview</strong>. Understanding these concepts is critical for freshers aiming to build a high-converting, ATS-friendly resume.
            </p>
          ...
          <section className="bg-white p-8 sm:p-10 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 mt-10 hover:-translate-y-1 transition-transform duration-300 relative overflow-hidden group">
            ...
            <p className="text-slate-600 mb-6 text-sm leading-relaxed relative z-10">
              Explore the core principles of <strong>What Makes a Resume ATS Friendly?</strong>. Understanding these concepts is critical for freshers aiming to build a high-converting, ATS-friendly resume.
            </p>
            <div className="pl-4 sm:pl-12 border-l border-slate-100 relative z-10 space-y-6">
              ...
              <div className="relative">
                ...
                <p className="text-slate-600 leading-relaxed">
                  Implementing text parsability strategically improves formatting and boosts ATS parsability for this section.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <p className="text-slate-600 leading-relaxed">
                  Implementing semantic structure strategically improves formatting and boosts ATS parsability for this section.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <p className="text-slate-600 leading-relaxed">
                  Implementing keyword density strategically improves formatting and boosts ATS parsability for this section.
                </p>
              </div>
      </div></section>
          ...
          <section className="bg-white p-8 sm:p-10 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 mt-10 hover:-translate-y-1 transition-transform duration-300 relative overflow-hidden group">
            ...
            <h2 className="text-lg sm:text-xl  mb-5 text-slate-900 flex items-center gap-3 relative z-10">
              ...
              ATS Friendly vs. Traditional Resumes: Key Differences
            </h2>
            <p className="text-slate-600 mb-6 text-sm leading-relaxed relative z-10">
              Explore the core principles of <strong>ATS Friendly vs. Traditional Resumes: Key Differences</strong>. Understanding these concepts is critical for freshers aiming to build a high-converting, ATS-friendly resume.
            </p>
            <div className="pl-4 sm:pl-12 border-l border-slate-100 relative z-10 space-y-6">
      </div></section>
          ...
          <section className="bg-white p-8 sm:p-10 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 mt-10 hover:-translate-y-1 transition-transform duration-300 relative overflow-hidden group">
            ...
            <h2 className="text-lg sm:text-xl  mb-5 text-slate-900 flex items-center gap-3 relative z-10">
              ...
              Why Indian MNCs Demand ATS Resumes
            </h2>
            <p className="text-slate-600 mb-6 text-sm leading-relaxed relative z-10">
              Explore the core principles of <strong>Why Indian MNCs Demand ATS Resumes</strong>. Understanding these concepts is critical for freshers aiming to build a high-converting, ATS-friendly resume.
            </p>
            <div className="pl-4 sm:pl-12 border-l border-slate-100 relative z-10 space-y-6">
      </div></section>
          ...
          <section className="bg-white p-8 sm:p-10 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 mt-10 hover:-translate-y-1 transition-transform duration-300 relative overflow-hidden group">
            ...
            <h2 className="text-lg sm:text-xl  mb-5 text-slate-900 flex items-center gap-3 relative z-10">
              ...
              How to Ensure Your Resume Meets ATS Standards
            </h2>
            <p className="text-slate-600 mb-6 text-sm leading-relaxed relative z-10">
              Explore the core principles of <strong>How to Ensure Your Resume Meets ATS Standards</strong>. Understanding these concepts is critical for freshers aiming to build a high-converting, ATS-friendly resume.
            </p>
            <div className="pl-4 sm:pl-12 border-l border-slate-100 relative z-10 space-y-6">
      </div></section>
          ...
          <section className="bg-white p-8 sm:p-10 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 mt-10 hover:-translate-y-1 transition-transform duration-300 relative overflow-hidden group">
            ...
            <p className="text-slate-600 mb-6 text-sm leading-relaxed relative z-10">
              Explore the core principles of <strong>FAQs About ATS Friendly Resumes</strong>. Understanding these concepts is critical for freshers aiming to build a high-converting, ATS-friendly resume.
            </p>
            <div className="pl-4 sm:pl-12 border-l border-slate-100 relative z-10 space-y-6">
      </div></section>
            ...
            <section className="bg-white p-8 sm:p-10 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 mt-16 relative overflow-hidden">
              ...
              <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100 hover:border-indigo-200 transition-colors">
                <h3 className="font-bold text-slate-900 text-sm flex items-start gap-3">
                  ...
                  What is the meaning of an ATS friendly resume?
                </h3>
                <p className="text-slate-600 mt-3 ml-8 leading-relaxed">
                  An ATS-friendly resume is formatted specifically to be read and understood by Applicant Tracking Systems software without losing data.
                </p>
              </div>
              ...
              <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100 hover:border-indigo-200 transition-colors">
                ...
                <p className="text-slate-600 mt-3 ml-8 leading-relaxed">
                  ATS stands for Applicant Tracking System, which is software used by recruiters to organize and filter job applications.
                </p>
              </div>
              ...
              <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100 hover:border-indigo-200 transition-colors">
                ...
                <p className="text-slate-600 mt-3 ml-8 leading-relaxed">
                  If you can copy all the text from your PDF and paste it into a plain text editor smoothly without missing words, it is likely ATS friendly.
                </p>
              </div>
              ...
              <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100 hover:border-indigo-200 transition-colors">
                ...
                <p className="text-slate-600 mt-3 ml-8 leading-relaxed">
                  Most mid-to-large companies and MNCs like TCS, Infosys, and Wipro use ATS to handle bulk hiring.
                </p>
              </div>
              ...
              <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100 hover:border-indigo-200 transition-colors">
                ...
                <p className="text-slate-600 mt-3 ml-8 leading-relaxed">
                  Not necessarily. It should be clean and professional, which is often preferred by recruiters over overly designed, flashy templates.
                </p>
              </div>
              ...
              <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100 hover:border-indigo-200 transition-colors">
                <h3 className="font-bold text-slate-900 text-sm flex items-start gap-3">
                  <span className="text-indigo-500 font-black text-lg leading-none">Q.</span>
                  Can I put my photo on an ATS resume?
                </h3>
                <p className="text-slate-600 mt-3 ml-8 leading-relaxed">
                  It is not recommended. Photos can confuse ATS parsers and are generally not required for IT and corporate roles in India.
                </p>
              </div>
              ...
              <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100 hover:border-indigo-200 transition-colors">
                <h3 className="font-bold text-slate-900 text-sm flex items-start gap-3">
                  <span className="text-indigo-500 font-black text-lg leading-none">Q.</span>
                  What happens if a resume is not ATS friendly?
                </h3>
                <p className="text-slate-600 mt-3 ml-8 leading-relaxed">
                  The software may scramble the text or fail to identify your skills, resulting in automatic rejection even if you are highly qualified.
                </p>
              </div>
              ...
              <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100 hover:border-indigo-200 transition-colors">
                <h3 className="font-bold text-slate-900 text-sm flex items-start gap-3">
                  <span className="text-indigo-500 font-black text-lg leading-none">Q.</span>
                  Where can I find ATS friendly templates?
                </h3>
                <p className="text-slate-600 mt-3 ml-8 leading-relaxed">
                  NextCV offers a wide range of free, verified ATS-friendly resume templates tailored for Indian job seekers.
                </p>
              </div>
              </div>
            </section>
