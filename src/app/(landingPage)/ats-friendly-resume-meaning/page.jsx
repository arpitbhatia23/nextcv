...
export const metadata = createSeoMetadata({
  ...
  description:
    "Understand what an ATS-friendly resume means, why companies use ATS systems and how freshers can create resumes that pass screening.",
  path: "/ats-friendly-resume-meaning",
  keywords: ["ats friendly resume", "ats resume", "ats resume format", "ats resume for freshers"],
});
              ...
              <div className="mt-6 space-y-4">
                <div className="rounded-xl border border-slate-100 bg-slate-50 p-4 sm:p-5">
                  <h3 className="flex items-start gap-2 text-base font-bold leading-snug text-slate-900 sm:text-lg">
                    ...
                    <span>{"Text Parsability"}</span>
                  </h3>

                  <p className="mt-2 pl-7 text-sm leading-7 text-slate-600">
                    {
                      "Apply text parsability carefully to improve clarity, ATS readability and the overall presentation of your resume."
                    }
                  </p>
                </div>
                ...
                <div className="rounded-xl border border-slate-100 bg-slate-50 p-4 sm:p-5">
                  ...
                  <p className="mt-2 pl-7 text-sm leading-7 text-slate-600">
                    {
                      "Apply semantic structure carefully to improve clarity, ATS readability and the overall presentation of your resume."
                    }
                  </p>
                </div>
                ...
                <div className="rounded-xl border border-slate-100 bg-slate-50 p-4 sm:p-5">
                  ...
                  <p className="mt-2 pl-7 text-sm leading-7 text-slate-600">
                    {
                      "Apply keyword density carefully to improve clarity, ATS readability and the overall presentation of your resume."
                    }
                  </p>
                </div>
              </div>
              ...
              <div className="relative z-10 space-y-3">
                <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
                  <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
                    ...
                    <span>{"What is the meaning of an ATS friendly resume?"}</span>
                  </h3>
                ...
                <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
                  <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
                    ...
                    <span>{"What does ATS stand for?"}</span>
                  </h3>
                ...
                <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
                  <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
                    ...
                    <span>{"Do all companies in India use ATS?"}</span>
                  </h3>
                ...
                <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
                  <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
                    ...
                    <span>{"Does an ATS friendly resume have to be boring?"}</span>
                  </h3>
                ...
                <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
                  <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
                    ...
                    <span>{"Can I put my photo on an ATS resume?"}</span>
                  </h3>
                ...
                <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
                  <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
                    ...
                    <span>{"What happens if a resume is not ATS friendly?"}</span>
                  </h3>
                ...
                <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
                  <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
                    ...
                    <span>{"Where can I find ATS friendly templates?"}</span>
                  </h3>
