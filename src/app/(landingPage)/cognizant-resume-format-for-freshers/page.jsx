  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12 bg-white">
      ...
      <h1 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900">
        Cognizant Resume Format for Freshers (2026)
      </h1>
      <p className="text-lg text-gray-700 mb-8">
        Build an ATS-friendly Cognizant resume format for freshers. Use professional templates for
        BCA, B.Tech, IT and fresher job applications.
      </p>
