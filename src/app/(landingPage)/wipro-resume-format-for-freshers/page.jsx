      ...
      <div className="min-h-screen bg-slate-50 font-sans text-slate-900 selection:bg-indigo-200">
        ...
        <div className="rounded-xl border border-slate-100 bg-slate-50 p-4 sm:p-5">
          <h3 className="flex items-start gap-2 text-base font-bold leading-snug text-slate-900 sm:text-lg">
            ...
            <span>{"Emphasizing Problem-Solving Skills"}</span>
          </h3>

          <p className="mt-2 pl-7 text-sm leading-7 text-slate-600">
            {"Apply emphasizing problem-solving skills carefully to improve clarity, ATS readability and the overall presentation of your resume."}
          </p>
        </div>
        ...
        <div className="rounded-xl border border-slate-100 bg-slate-50 p-4 sm:p-5">
          <h3 className="flex items-start gap-2 text-base font-bold leading-snug text-slate-900 sm:text-lg">
            ...
            <span>{"Showcasing Certifications and Workshops"}</span>
          </h3>

          <p className="mt-2 pl-7 text-sm leading-7 text-slate-600">
            {"Apply showcasing certifications and workshops carefully to improve clarity, ATS readability and the overall presentation of your resume."}
          </p>
        </div>
        ...
        <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
          <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
            ...
            <span>{"What is the Wipro resume format?"}</span>
          </h3>
        ...
        <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
          <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
            ...
            <span>{"Does Wipro accept 2-page resumes for freshers?"}</span>
          </h3>
        ...
        <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
          <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
            ...
            <span>{"What skills should I highlight for Wipro?"}</span>
          </h3>
        ...
        <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
          <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
            ...
            <span>{"Should I mention extracurricular activities for Wipro?"}</span>
          </h3>
        ...
        <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
          <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
            ...
            <span>{"How important are projects on a Wipro resume?"}</span>
          </h3>
        ...
        <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
          <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
            ...
            <span>{"Does Wipro use Applicant Tracking Systems?"}</span>
          </h3>
        ...
        <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
          <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
            ...
            <span>{"What font should I use for a Wipro resume?"}</span>
          </h3>
        ...
        <article className="rounded-xl border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-indigo-200 sm:p-5">
          <h3 className="flex items-start gap-3 text-sm font-bold leading-6 text-slate-900">
            ...
            <span>{"Can NextCV help me get hired at Wipro?"}</span>
          </h3>
