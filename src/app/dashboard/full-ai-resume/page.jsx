  ...
  if (process.env.NEXT_PUBLIC_ENABLE_CHAT) {
    ...
    const moveToNextField = () => {
      ...
      if (nextField < currentStep.fields.length) {
        ...
        addBotMessage(`Would you like to add another ${currentStep.key}?`, [
          "Yes",
          "No",
        ]);
      }
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto pr-2 custom-scrollbar">
            ...
            <div className="space-y-3">
              ...
              <div className="p-4 bg-slate-50 rounded-xl border border-slate-100 text-sm text-slate-600 hover:bg-slate-100 transition-colors">
                <p>
                  If you don't have information for a section, you can click the
                  "Skip" button below.
                </p>
              </div>
              <div className="p-4 bg-slate-50 rounded-xl border border-slate-100 text-sm text-indigo-700 font-medium">
                <p>
                  💡 Did you know? AI will automatically format your points to
                  be ATS-friendly.
                </p>
              </div>
            </div>
